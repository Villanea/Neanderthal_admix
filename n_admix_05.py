...
def neanderthal_admixture_model(num_eu=170,num_as=374,num_nean = 1,anc_time=900,mix_time1=2000,mix_time2=1000,mix_time3=1000,mix_time4=1000,split_time_1=120000,split_time_2=2300,split_time_3=1500,f1=0.02,f2=0.00,f3=0.00,f4=0.00,Ne0=10000,Ne1=2500,Ne2=10000,mu=1.5e-8,rho=1.0e-8,length=10000000,window_size = 100000,num_SNP = 1,num_rep=1000,coverage=False):
	...
	for sim in sims:
		...
		for tree in sim.trees():
			...
			if cur_site >= F_int[0] and cur_site < F_int[1]:
				...
				#print cur_win
				cur_site = (cur_start+cur_end)/2.0 #random.randint(cur_start,cur_end)
	outfile = open('outfile_all_onef.txt', 'w')
