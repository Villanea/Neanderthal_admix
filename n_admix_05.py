...
def neanderthal_admixture_model(num_eu=170,num_as=374,num_nean = 1,anc_time=900,mix_time1=2000,mix_time2=1000,split_time_1=120000,split_time_2=2300,split_time_3=1500,f1=0.02,f2=0.01,f3=0.01,f4=0.01,Ne0=10000,Ne1=2500,Ne2=10000,mu=1.5e-8,rho=1.0e-8,length=10000000,window_size = 1000000,num_SNP = 1,num_rep=1000,coverage=False): #when is best time to sample Neanderthal? 100 gen before f?
	...
	divergence = [msp.MassMigration(time=mix_time2,source=0,destination=2,proportion = f2), #BE dilution into EU
