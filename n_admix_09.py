...
#bedops
os.system("sort-bed outfile_map_wholegen_dil.bed > outfile_map_wholegen_dil_sorted.bed")
os.system("rm outfile_map_wholegen_dil.bed")
os.system("bedops --element-of 1 outfile_map_wholegen_dil_sorted.bed human_genome_mask_sorted.bed > outfile_map_wholegen_dil_masked.bed")
os.system("rm outfile_map_wholegen_dil_sorted.bed")
